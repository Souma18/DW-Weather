...
# 2.3 Tạo kết nối với database "db_etl_metadata"
engine_elt, SessionELT = connection_elt()
# 2.4.1 Tạo table "clean_log" nếu chưa có
...
def connection_clean(is_clean=True, is_transform=True):
    ...
    # 2.6.2 Gửi mail thông báo. Lưu Log thất bại vào table "clean_log" của database "db_etl_metadata"   
